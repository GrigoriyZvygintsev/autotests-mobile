...
TestTags из TalksApp:
    screen_talks_list, text_talks_title, input_search_talks,
    row_format_filters, row_level_filters, row_tag_filters,
    list_talks, progress_loading, text_no_results,
    card_talk_{slug}, text_talk_title_{slug}, text_talk_summary_{slug},
    badge_level_{slug}, text_duration_{slug}
"""
...
class TalksListPage(BasePage):
    ...
    def __init__(self, driver: AppiumDriver):
        ...
        self.screen = Text(
            driver=driver,
            locator=(AppiumBy.ID, "screen_talks_list"),
        ...
        self.title = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_talks_title"),
        ...
        self.format_filters = BaseElement(
            driver=driver,
            locator=(AppiumBy.ID, "row_format_filters"),
            name="Фильтры по формату",
        )
        self.level_filters = BaseElement(
            driver=driver,
            locator=(AppiumBy.ID, "row_level_filters"),
            name="Фильтры по уровню",
        )
        self.tag_filters = BaseElement(
            driver=driver,
            locator=(AppiumBy.ID, "row_tag_filters"),
        ...
        self.talks_list = BaseElement(
            driver=driver,
            locator=(AppiumBy.ID, "list_talks"),
        ...
        self.loading_progress = BaseElement(
            driver=driver,
            locator=(AppiumBy.ID, "progress_loading"),
            name="Индикатор загрузки",
        )
        self.no_results_text = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_no_results"),
        ...
        self.talk_card = BaseElement(
            driver=driver,
            locator=(AppiumBy.ID, "card_talk_{slug}"),
            name="Карточка доклада",
        )
        self.talk_title = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_talk_title_{slug}"),
            name="Заголовок доклада",
        )
        self.talk_summary = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_talk_summary_{slug}"),
            name="Описание доклада",
        )
        self.talk_level_badge = Text(
            driver=driver,
            locator=(AppiumBy.ID, "badge_level_{slug}"),
            name="Бейдж уровня доклада",
        )
        self.talk_duration = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_duration_{slug}"),
