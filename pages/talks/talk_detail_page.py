...
class TalkDetailPage(BasePage):
    ...
    def __init__(self, driver: AppiumDriver):
        ...
        self.screen = Text(
            driver=driver,
            locator=(AppiumBy.ID, "screen_talk_detail"),
        ...
        self.title = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_detail_title"),
            name="Заголовок доклада",
        )
        self.duration = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_detail_duration"),
            name="Длительность",
        )
        self.date = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_detail_date"),
            name="Дата доклада",
        )
        self.formats = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_detail_formats"),
            name="Форматы доклада",
        )
        self.summary = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_detail_summary"),
        ...
        self.audience = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_audience"),
            name="Аудитория",
        )
        self.topics = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_topics"),
            name="Темы",
        )
        self.takeaway = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_takeaway"),
            name="Takeaway",
        )
        ...
        self.outline_item = Text(
            driver=driver,
            locator=(AppiumBy.ID, "outline_item_{index}"),
        ...
        self.loading_progress = BaseElement(
            driver=driver,
            locator=(AppiumBy.ID, "progress_detail_loading"),
            name="Индикатор загрузки",
        )
        self.not_found_text = Text(
            driver=driver,
            locator=(AppiumBy.ID, "text_talk_not_found"),
